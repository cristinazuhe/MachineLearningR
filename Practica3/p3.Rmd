...
Nos quedamos con los datos de Boston sin las variables crim y crim01 y con unicamente variable crim, que es la que tratamos de predecir.
alpha=1 indica que estamos realizando un modelo LASSO. 
Nos quedamos con aquellas variables que superan un umbral prefijado, en nuestro caso lo establecemos a 0.1.
```{r}
...
```
Obtenemos un eror de 46.7%. Es excesivamente grande, lo que nos lleva a pensar que tenemos underfitting. 
